-- CreateEnum
CREATE TYPE "TypeUser" AS ENUM ('Administrador', 'Cliente');

-- CreateEnum
CREATE TYPE "Status" AS ENUM ('Pendente de Confirmação', 'Confirmado', 'Em Trânsito', 'Entrega Concluída', 'Cancelado');
